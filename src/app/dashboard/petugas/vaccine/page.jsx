  ...
  const [bookings, setBookings] = useState([
    {
      ...
      name: 'Bimo',
      animal: 'Cat',
      schedule: 'June 21, 2025',
      time: '11.00 am',
      owner: 'Rina',
      instructions: 'Vaksin khusus, jangan basah dulu',
      isDone: false,
    },
    {
      id: 2,
      ...
      time: '01.00 pm',
      owner: 'Fajar',
      instructions: 'Jangan kena angin',
      isDone: true,
    },
  ]);
  ...
  return (
    <div className="min-h-screen bg-[#fffaf5] font-sans">
      ...
      <main className="px-10 py-10">
        <h1 className="text-xl font-bold text-[#5c2e00] mb-2">Vaccine</h1>
