...
export default function PetHotelBookingPage() {
  const [bookings, setBookings] = useState([
    {
      id: 1,
      name: 'Luna',
      animal: 'Cat',
      schedule: 'June 22, 2025',
      time: '3.00 pm',
      owner: 'Salma',
      instructions: 'Berikan mainan favoritnya setiap malam',
      isDone: false,
    },
    {
      id: 2,
      name: 'Oreo',
      animal: 'Dog',
      schedule: 'June 23, 2025',
      time: '4.00 pm',
      owner: 'Rizky',
      instructions: 'Jangan lupa vitamin malam',
      isDone: true,
    },
  ]);
  ...
  return (
    <div className="min-h-screen bg-[#fffaf5] font-sans">
      ...
      <main className="px-10 py-10">
        <h1 className="text-xl font-bold text-[#5c2e00] mb-2">Pet Hotel</h1>
